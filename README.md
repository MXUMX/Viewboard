...
ViewBoard is a client-side NeoForge mod for Minecraft 1.21.5 that adds a keyboard map screen and keybind-management tools to the controls menu. The screens help show which keys are used, conflicting, ignored, grouped, or still free.

This branch (`codex/neoforge-1.21.5`) targets Minecraft `1.21.5` on NeoForge `21.5.97`.
...
```text
viewboard-neoforge-1.21.5-1.1.0.jar
viewboard-neoforge-1.21.5-1.1.0-sources.jar
```
