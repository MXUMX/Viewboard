...
```text
viewboard-fabric-<minecraft-version>-<mod-version>.jar
viewboard-fabric-<minecraft-version>-<mod-version>-sources.jar
```

For example:

```text
viewboard-fabric-1.20.1-1.1.0.jar
viewboard-fabric-1.20.1-1.1.0-sources.jar
```
...
- `build.gradle` and `gradle.properties` define the Fabric build
